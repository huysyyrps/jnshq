...
public class ConversationListAdapter extends IConversationAdapter {
    ...
    //header
    private List<ConversationInfo> mHeaderDataSource = new ArrayList<>();

    public ConversationListAdapter() {

    }

    public void setHeaderDataSource(List<ConversationInfo> headerDataSource) {
    ...
    public ConversationInfo getItem(int position) {
        if (position < mHeaderDataSource.size()) {
            return mHeaderDataSource.get(position);
        }
        return mDataSource.get(position - mHeaderDataSource.size());
    }

    @Override
    public int getItemCount() {
        return mHeaderDataSource.size() + mDataSource.size();
    }
