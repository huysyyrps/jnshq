...
public class GroupMemberManagerLayout extends LinearLayout implements IGroupMemberLayout {
    ...
    private void init() {
        ...
        mTitleBar.getRightTextView().setText("管理");
        mTitleBar.getRightTextView().setOnClickListener(new OnClickListener() {
            @Override
        ...
        mAdapter.setMemberChangedCallback(new IGroupMemberChangedCallback() {
            ...
            public void onMemberRemoved(GroupMemberInfo memberInfo) {
                mTitleBar.getCenterTextView().setText("群成员(" + mGroupInfo.getMemberDetails().size() + ")");
            }
        });
...
//    }
    ...
    public void setDataSource(GroupInfo groupInfo) {
        ...
        if (groupInfo != null) {
            mTitleBar.getCenterTextView().setText("群成员(" + groupInfo.getMemberDetails().size() + ")");
        }
    }
