...
import com.sdjnshq.architecture.data.manager.NetState;
...
public class BaseFragment extends SwipeBackFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (titleBar != null) {
            View back = titleBar.findViewById(R.id.ll_back);
            if(back!=null) {
    ...
    protected ViewModelProvider getAppViewModelProvider() {
        return ((CircleApplication) mActivity.getApplicationContext()).getAppViewModelProvider(mActivity);
    }
