...
import com.sdjnshq.circle.ui.adapter.SelectItemAdapter;
...
public final class DialogHelper {
    ...
    public static AlertDialog.Builder getRecyclerViewDialog(Context context, List<String> itemList, BaseQuickAdapter.OnItemClickListener listener) {
        ...
        recyclerView.setPadding(ScreenUtil.getPxByDp(16), ScreenUtil.getPxByDp( 16),
                ScreenUtil.getPxByDp( 16), ScreenUtil.getPxByDp(16));
        recyclerView.setLayoutParams(params);
        recyclerView.setLayoutManager(new LinearLayoutManager(context, LinearLayoutManager.VERTICAL,false));
        SelectItemAdapter adapter = new SelectItemAdapter(itemList);
