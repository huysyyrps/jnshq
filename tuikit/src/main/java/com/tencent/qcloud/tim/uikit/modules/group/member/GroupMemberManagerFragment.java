...
public class GroupMemberManagerFragment extends BaseFragment {
    ...
    private void init() {
        ...
        mMemberLayout.getCommonTitleBar().findViewById(R.id.ll_back).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onResume() {
        super.onResume();
        BarUtils.setStatusBarVisibility(getActivity().getWindow(),true);
    }
}
